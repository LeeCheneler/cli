...
${EXAMPE_CLI_OPTIONS.name} [command] [positionals] [--arguments]
...
${EXAMPE_CLI_OPTIONS.name} example [positionals]
...
${EXAMPE_CLI_OPTIONS.name} example [--arguments]
...
${EXAMPE_CLI_OPTIONS.name} example [positionals] [--arguments]
